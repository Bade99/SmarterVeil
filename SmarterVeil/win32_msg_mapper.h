...
#else
#define msgToString(...) "UnknownMessage"
#define hittestToString(...) "UnknownHitTest"
#define HKLtoString(...) "UnknownHKL"
/*
static const char* msgToString(unsigned int) {
	const char* res = "UnknownMessage";
	return res;
}

static const char* hittestToString(unsigned int) {
	const char* res = "UnknownHitTest";
	return res;
}
static const char* HKLtoString(char code[9]) {
